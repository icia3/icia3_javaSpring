package com.jsframe.cumarket.util;
...
public class PagingUtil {
    ...
    private int totalPage; //전체 데이터의 개수
    ...
    public String makePaging(){
        ...
        // [이전] 6 7 8 9 10 [다음] - 6,7,8,9,10 번이 한 그룹.
        int curGroup = (pageNum % pageCnt) > 0 ?  //pageNum을 pageCnt로 나눴을때의 나머지가 0보다 클 경우
                pageNum / pageCnt + 1 : //참이면 몫+1
                pageNum / pageCnt;  //거짓이면  몫
